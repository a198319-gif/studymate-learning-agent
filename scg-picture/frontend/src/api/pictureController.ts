...
/** generatePicture POST /api/picture/ai/generate_picture */
export async function generatePictureUsingPost(
  body: { prompt: string },
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseString_>('/api/picture/ai/generate_picture', {
    method: 'POST',

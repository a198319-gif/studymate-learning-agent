<template>
  <div class="batch-edit-picture-modal">
    <a-modal v-model:visible="visible" title="Batch Edit Images" :footer="false" @cancel="closeModal">
      <a-typography-paragraph type="secondary">* Only applies to images on current page</a-typography-paragraph>
      <!-- 批量创建表单 -->
      <a-form name="formData" layout="vertical" :model="formData" @finish="handleSubmit">
        ...
        <a-form-item name="nameRule" label="Naming Rule">
          <a-input
            ...
            placeholder="Enter naming rule, use {index} for dynamic generation"
            allow-clear
          />
        </a-form-item>
        <a-form-item>
...
const getTagCategoryOptions = async () => {
  ...
  if (res.data.code === 0 && res.data.data) {
    ...
    message.error('Failed to get tag/category list, ' + res.data.message)
  }
}
